...
class DekalbSpider(Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.start_urls = ["https://www.dekalbcountysheriff.org/roster.php"]

    def parse(self, response):
        profile_paths = response.xpath(
            '//div[@id="intContentContainer"]/div/table//table[@class="inmateTable"]//a[@class="text2"]/@href'
        ).getall()
    ...
    def parse_profile(self, profile):
        allkeys = [
            k.strip()
            for k in profile.xpath('//*[@id="intContentContainer"]/div/table//table/tr/td/span/text()').extract()
        ]
